...
```bash
python3 ./.cursor/skills/continuous-learning-v2/scripts/instinct-cli.py import <file-or-url>
```
...
5. Save to `./.cursor/homunculus/instincts/inherited/`
...
New instincts saved to: ./.cursor/homunculus/instincts/inherited/
